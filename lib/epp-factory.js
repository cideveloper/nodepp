...
var NameStoreExtension = require('../lib/namestore-extension.js');
...
EppFactory.generate = function(registry, config) {
    ...
    config.extensionClasses.forEach(function(extensionClass) {
        ...
        case 'HexonetExtension':
            ...
            break;
        case 'NameStoreExtension':
            mixer = NameStoreExtension;
            // console.log("Applying namestore mixin");
            mapper = NameStoreExtension.mixinMapper();
            break;
        default:
        }
