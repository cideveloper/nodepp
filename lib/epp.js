...
EPP.prototype.checkDomain = function(data, transactionId) {
    ...
    var processedExtension = this.processExtensions(data, 'checkDomain');
...
EPP.prototype.infoDomain = function(data, transactionId) {
    ...
    var processedExtension = this.processExtensions(data, 'infoDomain');
...
EPP.prototype.createDomain = function(data, transactionId) {
    ...
    var createData = {};
    createData['_attr'] = {"xmlns:domain": domainNamespace.xmlns};
    createData['domain:name'] = data.name;
    createData['domain:period'] = this.processDomainPeriod(data.period);
    createData['domain:ns'] = nsHostObjects;
    if (data.registrant) createData['domain:registrant'] = data.registrant;
    if (contacts) createData['domain:contact'] = contacts;
    this.normaliseVariants('authInfo', data, ["authcode", "authCode", "auth_code", "password", "pw"]);
    data.authInfo = data.authInfo || '';
...
EPP.prototype.renewDomain = function(data, transactionId) {
    ...
    var processedExtension = this.processExtensions(data, 'renewDomain');
...
EPP.prototype.deleteDomain = function(data, transactionId) {
    ...
    var processedExtension = this.processExtensions(data, 'deleteDomain');
