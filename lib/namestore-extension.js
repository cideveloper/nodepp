var commandMapping = [{
    ...
    "updateDomain": "updateDomainExtension",
...
NameStoreExtension.prototype.renewDomainExtension = function(data) {
    var config = this.config;
    var namespace = config.namespaces.NameStore.xmlns;
    var processedExtension = {
        "namestoreExt:namestoreExt" : {
...
NameStoreExtension.prototype.updateDomainExtension = function(data) {
    var config = this.config;
    var namespace = config.namespaces.NameStore.xmlns;
    var processedExtension = {
        "namestoreExt:namestoreExt" : {
